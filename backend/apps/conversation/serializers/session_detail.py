...
# Session detail success response serializer
class SessionDetailSuccessResponseSerializer(GenericResponseSerializer):
    """Serializer for successful session detail response.

    This serializer defines the structure of the session detail success response.
...
class SessionDetailNotFoundResponseSerializer(GenericResponseSerializer):
...
class SessionDetailAuthErrorResponseSerializer(GenericResponseSerializer):
...
class SessionDetailPermissionDeniedResponseSerializer(GenericResponseSerializer):
    ...
    # Error message
    error = serializers.CharField(
        default=_("You do not have permission to access this session."),
        read_only=True,
        help_text=_("Error message."),
    )
